...
type TranslationSet struct {
	...
	DecreaseHalfScreenModeSidePanelWidth  string
	IncreaseHalfScreenModeSidePanelWidth  string
...
func EnglishTranslationSet() *TranslationSet {
	return &TranslationSet{
		...
		DecreaseHalfScreenModeSidePanelWidth: "Decrease half screen mode side panel width",
		IncreaseHalfScreenModeSidePanelWidth: "Increase half screen mode side panel width",
